...
def generate_font_blob(font_path, point_size, order, cell_width, cell_height):
    # Resolve to absolute path relative to this script
    ...
    for ch in order:
        ...
        # effective width (last non‑empty column + 1)
        eff_w = 0
...
if __name__ == "__main__":
    # Characters to include in all fonts
    order = " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~"

    # Define the fonts you want in this firmware
    font_specs = [
        {
            "name": "Mono5x8",
    ...
    for spec in font_specs:
        ...
        print("}\n")
        font_map_entries.append(f"    '{var_name}': {var_name}")
